...
describe('app-config', () => {
  ...
  describe('readAppConfig', () => {
    it('returns an empty config when config file does not exist', async () => {
    ...
    it('returns an empty config for corrupted JSON without crashing', async () => {
...
describe('app-config installation identity', () => {
  let dataDir: string;

  beforeEach(async () => {
    dataDir = await mkdtemp(path.join(tmpdir(), 'od-installation-identity-'));
  });
