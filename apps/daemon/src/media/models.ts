...
// Product-facing shorthand aliases onto canonical registry ids. Currently
// empty: no registered shorthand is remapped, so unqualified names must match
// a registry id exactly.
