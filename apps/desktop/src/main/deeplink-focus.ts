 ...
 * `BrowserWindow.getAllWindows()[0]`: a packaged cold start puts the splash
 * ahead of the main window, so window 0 is never the main window in a running
 * app — focusing it is a silent no-op.
