...
export interface Dict {
  ...
  'projectGit.waitingUnbind': string;
  'projectGit.editableNotice': string;
  'projectGit.included': string;
  'projectGit.ignored': string;
  'projectGit.private': string;
  'projectGit.missing': string;
  'projectGit.contentDependencies': string;
  'projectGit.runtimeDependencies': string;
  'projectGit.records': string;
  'projectGit.choose': string;
  'projectGit.binding.empty': string;
  'projectGit.binding.shared_history': string;
  'projectGit.binding.independent_history': string;
  'projectGit.binding.different_project': string;
  'projectGit.openFailed': string;
  'projectGit.history': string;
  'projectGit.settings': string;
  'projectGit.url': string;
  'projectGit.branch': string;
  'projectGit.testConnection': string;
  'projectGit.preview': string;
  'projectGit.confirm': string;
  'projectGit.unbind': string;
  'projectGit.syncNow': string;
  'projectGit.pause': string;
  'projectGit.resume': string;
  'projectGit.restore': string;
  'projectGit.conflicts': string;
  'projectGit.localSide': string;
  'projectGit.remoteSide': string;
  'projectGit.ancestor': string;
  'projectGit.stalePreview': string;
  'projectGit.fileOnlyWarning': string;
  'projectGit.daemonAuthNotice': string;
  'projectGit.autoSyncNotice': string;
  'projectGit.externalEditorNotice': string;
  'projectGit.newProjectNotice': string;
  'projectGit.phase.enable_pending': string;
  'projectGit.phase.waiting_idle': string;
  'projectGit.phase.dirty': string;
  'projectGit.phase.checkpointing': string;
  'projectGit.phase.local_saved': string;
  'projectGit.phase.pending_push': string;
  'projectGit.phase.syncing': string;
  'projectGit.phase.synced': string;
  'projectGit.phase.paused': string;
  'projectGit.phase.conflict': string;
  'projectGit.phase.auth_required': string;
  'projectGit.phase.external_git_busy': string;
  'projectGit.phase.recovering': string;
  'projectGit.phase.failed': string;
  ...
  'settings.agentNetwork.title': string;
  'settings.agentNetwork.hint': string;
  'settings.agentNetwork.modeLegend': string;
  'settings.agentNetwork.mode.inherit': string;
  'settings.agentNetwork.mode.direct': string;
  'settings.agentNetwork.mode.custom': string;
  'settings.agentNetwork.proxyUrl': string;
  'settings.agentNetwork.proxyUrlPlaceholder': string;
  'settings.agentNetwork.proxyUrlExamples': string;
  'settings.agentNetwork.noProxy': string;
  'settings.agentNetwork.noProxyPlaceholder': string;
  'settings.agentNetwork.username': string;
  'settings.agentNetwork.password': string;
  'settings.agentNetwork.passwordConfigured': string;
  'settings.agentNetwork.clearPassword': string;
  'settings.agentNetwork.save': string;
  'settings.agentNetwork.saving': string;
  'settings.agentNetwork.saved': string;
  'settings.agentNetwork.saveFailure': string;
  'settings.agentNetwork.validation.proxyUrlRequired': string;
  'settings.agentNetwork.validation.proxyUrlInvalid': string;
  'settings.agentNetwork.validation.proxyUrlTooLong': string;
  'settings.agentNetwork.validation.noProxyTooLong': string;
  'settings.agentNetwork.validation.usernameTooLong': string;
  'settings.agentNetwork.validation.passwordTooLong': string;
  'settings.agentNetwork.validation.controlCharacters': string;
  'settings.agentNetwork.validation.passwordRequiresUsername': string;
  ...
  // entry point (nav-rail account menu) so a stray click
