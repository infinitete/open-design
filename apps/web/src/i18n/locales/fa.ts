...
export const fa: Dict = {
  ...
  'projectGit.settings': "تنظیمات نسخه‌ها",
  'projectGit.url': "نشانی مخزن",
  'projectGit.branch': "شاخه",
  'projectGit.testConnection': "آزمایش اتصال",
  'projectGit.preview': "پیش‌نمایش",
  'projectGit.confirm': "تأیید",
  'projectGit.unbind': "قطع اتصال مخزن",
  'projectGit.syncNow': "همگام‌سازی اکنون",
  'projectGit.pause': "توقف موقت همگام‌سازی خودکار",
  'projectGit.resume': "ادامهٔ همگام‌سازی خودکار",
  'projectGit.restore': "بازیابی",
  'projectGit.conflicts': "تعارض‌ها",
  'projectGit.localSide': "محلی",
  'projectGit.remoteSide': "راه‌دور",
  'projectGit.ancestor': "نیای مشترک",
  'projectGit.stalePreview': "این پیش‌نمایش قدیمی شده است. دوباره از پروژهٔ فعلی پیش‌نمایش بگیرید.",
  'projectGit.fileOnlyWarning': "پیش‌نمایش مسیرهای شامل‌شده، نادیده‌گرفته‌شده و خصوصی را نشان می‌دهد. نسخه‌های فقط شامل فایل ممکن است گفتگوها یا تنظیمات را کامل بازیابی نکنند.",
  'projectGit.daemonAuthNotice': "دسترسی راه‌دور از اطلاعات احراز هویت Git روی رایانهٔ اجراکنندهٔ سرویس Open Design استفاده می‌کند. آزمایش اتصال، مجوز ارسال را تأیید نمی‌کند.",
  'projectGit.autoSyncNotice': "Open Design نسخه‌های محلی را ذخیره می‌کند و پس از تنظیم مخزن راه‌دور خودکار همگام می‌شود. نسخهٔ محلی به معنی نسخهٔ ارسال‌شده نیست.",
  'projectGit.externalEditorNotice': "کامیت‌های دیگران و ویرایشگرهای خارجی پشتیبانی می‌شوند. Open Design پیش از اعمال عملیات، تغییرات را بررسی می‌کند.",
  'projectGit.newProjectNotice': "مدیریت نسخهٔ محلی به‌طور پیش‌فرض فعال است. فایل‌های پروژه و سوابق قابل‌انتقال Open Design شامل می‌شوند؛ اطلاعات احراز هویت، تنظیمات خصوصی، پایگاه‌های داده، وابستگی‌ها و فایل‌های تولیدشده نادیده گرفته می‌شوند. تا تنظیم مخزن راه‌دور چیزی ارسال نمی‌شود.",
  'projectGit.phase.enable_pending': "مدیریت نسخه نیاز به تنظیم دارد",
  'projectGit.phase.waiting_idle': "در انتظار بیکار شدن پروژه",
  'projectGit.phase.dirty': "تغییرات به‌صورت نسخه ذخیره نشده‌اند",
  'projectGit.phase.checkpointing': "در حال ذخیرهٔ نسخه",
  'projectGit.phase.local_saved': "محلی ذخیره شد",
  'projectGit.phase.pending_push': "در انتظار ارسال",
  'projectGit.phase.syncing': "در حال همگام‌سازی",
  'projectGit.phase.synced': "همگام شد",
  'projectGit.phase.paused': "همگام‌سازی خودکار متوقف شده است",
  'projectGit.phase.conflict': "تعارض‌ها نیاز به حل دارند",
  'projectGit.phase.auth_required': "احراز هویت لازم است",
  'projectGit.phase.external_git_busy': "عملیات خارجی Git در حال اجراست",
  'projectGit.phase.recovering': "در حال بازیابی",
  'projectGit.phase.failed': "عملیات نسخه ناموفق بود",
  'projectGit.rebindNotice': "تغییر اتصال، همگام‌سازی خودکار را پیش از پیش‌نمایش متوقف می‌کند. نسخه‌های محلی باقی می‌مانند. تأثیر مخزن جدید بر پروژه را بررسی کنید.",
  'projectGit.unbindNotice': "قطع اتصال نسخه‌های محلی را نگه می‌دارد و منتظر پایان عملیات فعال می‌ماند.",
  'projectGit.waitingUnbind': "در انتظار پایان عملیات فعال پیش از قطع اتصال…",
  'projectGit.editableNotice': "بدون Git یا هویت Git هم می‌توانید ویرایش پروژه را ادامه دهید. برای ذخیرهٔ نسخه‌ها آن‌ها را روی رایانهٔ اجراکنندهٔ Open Design تنظیم کنید.",
  'projectGit.included': "مسیرهای شامل‌شده",
  'projectGit.ignored': "مسیرهای نادیده‌گرفته‌شده",
  'projectGit.private': "مسیرهای خصوصی",
  'projectGit.missing': "مسیرهای مفقود",
  'projectGit.contentDependencies': "منابع محتوای مفقود",
  'projectGit.runtimeDependencies': "وابستگی‌های اجرایی مفقود",
  'projectGit.records': "سوابق پروژه",
  'projectGit.choose': "انتخاب منبع",
  'projectGit.binding.empty': "مخزن راه‌دور خالی است.",
  'projectGit.binding.shared_history': "مخزن‌ها تاریخچهٔ مشترک دارند.",
  'projectGit.binding.independent_history': "مخزن‌ها تاریخچه‌های مستقل دارند. سوابق و فایل‌هایی را که باید نگه داشته شوند انتخاب کنید.",
  'projectGit.binding.different_project': "مخزن راه‌دور شامل پروژهٔ دیگری است. پیش از اتصال همهٔ انتخاب‌ها را بررسی کنید.",
  ...
  'settings.baseUrlDefaultHint': 'فقط برای درگاه API سازگار یا endpoint جایگزین ارائه‌دهنده تغییر دهید.',
  ...
  'settings.agentNetwork.title': 'پراکسی شبکه',
  'settings.agentNetwork.hint': 'فقط برای این CLI اعمال می‌شود. ترافیک Open Design تغییری نمی‌کند.',
  'settings.agentNetwork.modeLegend': 'حالت پراکسی شبکه',
  'settings.agentNetwork.mode.inherit': 'پیروی از سیستم',
  'settings.agentNetwork.mode.direct': 'مستقیم',
  'settings.agentNetwork.mode.custom': 'سفارشی',
  'settings.agentNetwork.proxyUrl': 'نشانی پراکسی',
  'settings.agentNetwork.proxyUrlPlaceholder': 'http://proxy.example:8080',
  'settings.agentNetwork.proxyUrlExamples': 'نمونه‌ها: http://host:8080، https://host:8443 یا socks5://host:1080.',
  'settings.agentNetwork.noProxy': 'نشانی‌های مستثنا',
  'settings.agentNetwork.noProxyPlaceholder': 'localhost, .example.com',
  'settings.agentNetwork.username': 'نام کاربری',
  'settings.agentNetwork.password': 'رمز عبور',
  'settings.agentNetwork.passwordConfigured': 'رمز عبور تنظیم شده است',
  'settings.agentNetwork.clearPassword': 'پاک کردن رمز عبور',
  'settings.agentNetwork.save': 'ذخیره تنظیمات پراکسی',
  'settings.agentNetwork.saving': 'در حال ذخیره…',
  'settings.agentNetwork.saved': 'تنظیمات پراکسی ذخیره شد.',
  'settings.agentNetwork.saveFailure': 'ذخیره تنظیمات پراکسی ممکن نشد.',
  'settings.agentNetwork.validation.proxyUrlRequired': 'نشانی پراکسی را وارد کنید.',
  'settings.agentNetwork.validation.proxyUrlInvalid': 'از نشانی میزبان با http://، https:// یا socks5:// و بدون اطلاعات ورود استفاده کنید.',
  'settings.agentNetwork.validation.proxyUrlTooLong': 'نشانی پراکسی بیش از حد طولانی است.',
  'settings.agentNetwork.validation.noProxyTooLong': 'نشانی‌های مستثنا بیش از حد طولانی هستند.',
  'settings.agentNetwork.validation.usernameTooLong': 'نام کاربری بیش از حد طولانی است.',
  'settings.agentNetwork.validation.passwordTooLong': 'رمز عبور بیش از حد طولانی است.',
  'settings.agentNetwork.validation.controlCharacters': 'فیلدهای پراکسی نمی‌توانند نویسه کنترلی داشته باشند.',
  'settings.agentNetwork.validation.passwordRequiresUsername': 'پیش از تنظیم رمز عبور، نام کاربری را وارد کنید.',
  'settings.cliEnvTitle': 'پیشرفته: نقطه‌های پایانی و مسیرهای سفارشی',
  'settings.cliEnvHint': 'از این گزینه‌ها برای بازنویسی محیط CLI انتخاب‌شده استفاده کنید: API key، Base URL ارائه‌دهنده، home سفارشی یا مسیر اجرایی غیر استاندارد. اگر Base URL تنظیم نشود، CLI از endpoint پیش‌فرض ارائه‌دهنده استفاده می‌کند. اطلاعات محرمانه در تنظیمات محلی برنامه می‌مانند و فقط CLI انتخاب‌شده آن‌ها را می‌بیند.',
  'settings.cliEnvClaudeConfigDir': 'پوشه پیکربندی Claude Code',
  'settings.cliEnvClaudeBaseUrl': 'Base URL ارائه‌دهنده Claude',
  ...
  'settings.cliEnvCodexBaseUrl': 'Base URL ارائه‌دهنده Codex/OpenAI',
  ...
  'inlineSwitcher.modelLockedHint': 'این مدل در حال حاضر برای حساب شما در دسترس نیست',
  ...
  'chat.slashPopoverTitle': 'دستورها',
  'chat.slashPopoverHint': '↑↓ پیمایش · enter انتخاب · esc بستن',
  'chat.slashPopoverAria': 'دستورهای اسلش',
