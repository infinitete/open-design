...
export const en: Dict = {
  ...
  'projectGit.waitingUnbind': "Waiting for active operations before disconnecting…",
  'projectGit.editableNotice': "You can continue editing this project without Git or a Git identity. Configure these on the computer running the Open Design service to save versions.",
  'projectGit.included': "Included paths",
  'projectGit.ignored': "Ignored paths",
  'projectGit.private': "Private paths",
  'projectGit.missing': "Missing paths",
  'projectGit.contentDependencies': "Missing content resources",
  'projectGit.runtimeDependencies': "Missing runtime dependencies",
  'projectGit.records': "Project records",
  'projectGit.choose': "Choose a source",
  'projectGit.binding.empty': "The remote repository is empty.",
  'projectGit.binding.shared_history': "The repositories share history.",
  'projectGit.binding.independent_history': "The repositories have independent histories. Choose the records and files to keep.",
  'projectGit.binding.different_project': "The remote contains another project. Review every choice before binding.",
  'projectGit.openFailed': "The repository could not be opened. It was not added to recent projects.",
  'projectGit.history': "History",
  'projectGit.settings': "Version settings",
  'projectGit.url': "Repository URL",
  'projectGit.branch': "Branch",
  'projectGit.testConnection': "Test connection",
  'projectGit.preview': "Preview",
  'projectGit.confirm': "Confirm",
  'projectGit.unbind': "Disconnect repository",
  'projectGit.syncNow': "Sync now",
  'projectGit.pause': "Pause automatic sync",
  'projectGit.resume': "Resume automatic sync",
  'projectGit.restore': "Restore",
  'projectGit.conflicts': "Conflicts",
  'projectGit.localSide': "Local",
  'projectGit.remoteSide': "Remote",
  'projectGit.ancestor': "Common ancestor",
  'projectGit.stalePreview': "This preview is stale. Preview the current project again.",
  'projectGit.fileOnlyWarning': "The preview shows included, ignored, and private paths. File-only versions may not fully restore conversations or settings.",
  'projectGit.daemonAuthNotice': "Remote access uses the Git credentials on the computer running the Open Design service. A connection test does not prove push permission.",
  'projectGit.autoSyncNotice': "Open Design will save local versions and automatically sync when a remote is configured. Local versions are not the same as pushed versions.",
  'projectGit.externalEditorNotice': "Commits from other people and external editors are supported. Open Design checks for changes before applying an operation.",
  'projectGit.newProjectNotice': "Local version management is on by default. Project files and portable Open Design records are included; credentials, private settings, databases, dependencies, and generated files are ignored. Nothing is pushed until a remote is configured.",
  'projectGit.phase.enable_pending': "Versioning needs setup",
  'projectGit.phase.waiting_idle': "Waiting for project to be idle",
  'projectGit.phase.dirty': "Changes not versioned",
  'projectGit.phase.checkpointing': "Saving version",
  'projectGit.phase.local_saved': "Saved locally",
  'projectGit.phase.pending_push': "Waiting to push",
  'projectGit.phase.syncing': "Syncing",
  'projectGit.phase.synced': "Synced",
  'projectGit.phase.paused': "Automatic sync paused",
  'projectGit.phase.conflict': "Conflicts need resolution",
  'projectGit.phase.auth_required': "Authentication required",
  'projectGit.phase.external_git_busy': "External Git operation in progress",
  'projectGit.phase.recovering': "Recovering",
  'projectGit.phase.failed': "Version operation failed",
  ...
  'settings.baseUrlDefaultHint': 'Change this only for a compatible API gateway or alternate provider endpoint.',
  ...
  'settings.agentNetwork.modeLegend': 'Network proxy mode',
  ...
  'settings.agentNetwork.proxyUrlExamples': 'Examples: http://host:8080, https://host:8443, or socks5://host:1080.',
  ...
  'settings.agentNetwork.passwordConfigured': 'Password configured',
  'settings.agentNetwork.clearPassword': 'Clear password',
  'settings.agentNetwork.save': 'Save proxy settings',
  'settings.agentNetwork.saving': 'Saving…',
  'settings.agentNetwork.saved': 'Proxy settings saved.',
  'settings.agentNetwork.saveFailure': 'Could not save proxy settings.',
  'settings.agentNetwork.validation.proxyUrlRequired': 'Enter a proxy URL.',
  'settings.agentNetwork.validation.proxyUrlInvalid': 'Use a host-only http://, https://, or socks5:// URL without credentials.',
  'settings.agentNetwork.validation.proxyUrlTooLong': 'Proxy URL is too long.',
  'settings.agentNetwork.validation.noProxyTooLong': 'Bypass addresses are too long.',
  'settings.agentNetwork.validation.usernameTooLong': 'Username is too long.',
  'settings.agentNetwork.validation.passwordTooLong': 'Password is too long.',
  'settings.agentNetwork.validation.controlCharacters': 'Proxy fields cannot contain control characters.',
  'settings.agentNetwork.validation.passwordRequiresUsername': 'Enter a username before setting a password.',
  'settings.cliEnvTitle': 'Advanced: endpoints & custom paths',
  'settings.cliEnvHint': 'Use these to override the selected CLI environment: API keys, provider Base URLs, custom homes, or non-standard binary paths. Without a Base URL, the CLI uses its default provider endpoint. Secrets stay in local app config and only the selected CLI sees them.',
  'settings.cliEnvClaudeConfigDir': 'Claude Code config directory',
  'settings.cliEnvClaudeBaseUrl': 'Claude provider Base URL',
  'settings.cliEnvClaudeApiKey': 'Claude CLI API key',
  'settings.cliEnvCodexHome': 'Codex home',
  'settings.cliEnvCodexBin': 'Codex executable path',
  'settings.cliEnvCodexBaseUrl': 'Codex/OpenAI provider Base URL',
  ...
  'inlineSwitcher.modelLockedHint': 'This model is not currently available for your account',
  ...
  'chat.slashPopoverTitle': 'Commands',
  'chat.slashPopoverHint': '↑↓ navigate · enter to pick · esc to dismiss',
  'chat.slashPopoverAria': 'Slash commands',
