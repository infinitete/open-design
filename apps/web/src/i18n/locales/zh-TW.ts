...
export const zhTW: Dict = {
  ...
  'projectGit.settings': "版本設定",
  'projectGit.url': "儲存庫網址",
  'projectGit.branch': "分支",
  'projectGit.testConnection': "測試連線",
  'projectGit.preview': "預覽",
  'projectGit.confirm': "確認",
  'projectGit.unbind': "解除儲存庫連結",
  'projectGit.syncNow': "立即同步",
  'projectGit.pause': "暫停自動同步",
  'projectGit.resume': "恢復自動同步",
  'projectGit.restore': "還原",
  'projectGit.conflicts': "衝突",
  'projectGit.localSide': "本機",
  'projectGit.remoteSide': "遠端",
  'projectGit.ancestor': "共同祖先",
  'projectGit.stalePreview': "此預覽已過期，請重新預覽目前專案。",
  'projectGit.fileOnlyWarning': "預覽列出納入、忽略及私密路徑。僅含檔案的版本可能無法完整還原對話或設定。",
  'projectGit.daemonAuthNotice': "遠端存取使用執行 Open Design 服務的電腦上的 Git 憑證。連線測試不代表擁有推送權限。",
  'projectGit.autoSyncNotice': "Open Design 會儲存本機版本，並在設定遠端後自動同步。本機版本不等於已推送的版本。",
  'projectGit.externalEditorNotice': "支援其他人及外部編輯器的提交。Open Design 會在套用操作前檢查變更。",
  'projectGit.newProjectNotice': "預設啟用本機版本管理。納入專案檔案及可攜式 Open Design 紀錄；忽略憑證、私密設定、資料庫、相依套件及產生的檔案。設定遠端前不會推送。",
  'projectGit.phase.enable_pending': "版本管理待啟用",
  'projectGit.phase.waiting_idle': "等待專案閒置",
  'projectGit.phase.dirty': "變更尚未存為版本",
  'projectGit.phase.checkpointing': "正在儲存版本",
  'projectGit.phase.local_saved': "已儲存本機版本",
  'projectGit.phase.pending_push': "等待推送",
  'projectGit.phase.syncing': "正在同步",
  'projectGit.phase.synced': "已同步",
  'projectGit.phase.paused': "自動同步已暫停",
  'projectGit.phase.conflict': "需要解決衝突",
  'projectGit.phase.auth_required': "需要驗證",
  'projectGit.phase.external_git_busy': "外部 Git 操作進行中",
  'projectGit.phase.recovering': "正在復原",
  'projectGit.phase.failed': "版本操作失敗",
  'projectGit.rebindNotice': "更換連結會先暫停自動同步再預覽。本機版本會保留；請檢查新儲存庫對專案的影響。",
  'projectGit.unbindNotice': "解除連結會保留本機版本，並等待進行中的操作完成。",
  'projectGit.waitingUnbind': "正在等待進行中的操作完成後解除連結…",
  'projectGit.editableNotice': "缺少 Git 或 Git 身分時仍可繼續編輯專案。請在執行 Open Design 服務的電腦上設定，以儲存版本。",
  'projectGit.included': "納入的路徑",
  'projectGit.ignored': "忽略的路徑",
  'projectGit.private': "私密路徑",
  'projectGit.missing': "缺少的路徑",
  'projectGit.contentDependencies': "缺少的內容資源",
  'projectGit.runtimeDependencies': "缺少的執行相依項目",
  'projectGit.records': "專案紀錄",
  'projectGit.choose': "選擇來源",
  'projectGit.binding.empty': "遠端儲存庫是空的。",
  'projectGit.binding.shared_history': "儲存庫具有共同歷史。",
  'projectGit.binding.independent_history': "儲存庫的歷史彼此獨立，請選擇要保留的紀錄與檔案。",
  'projectGit.binding.different_project': "遠端含有其他專案，請在連結前檢查每個選項。",
  ...
  "settings.baseUrlDefaultHint": "僅在使用相容 API 閘道或其他供應商端點時修改。",
  ...
  "settings.agentNetwork.title": "網路代理",
  "settings.agentNetwork.hint": "僅套用至此 CLI。Open Design 的流量不受影響。",
  "settings.agentNetwork.modeLegend": "網路代理模式",
  "settings.agentNetwork.mode.inherit": "跟隨系統",
  "settings.agentNetwork.mode.direct": "直接連線",
  "settings.agentNetwork.mode.custom": "自訂",
  "settings.agentNetwork.proxyUrl": "代理 URL",
  "settings.agentNetwork.proxyUrlPlaceholder": "http://proxy.example:8080",
  "settings.agentNetwork.proxyUrlExamples": "範例：http://host:8080、https://host:8443 或 socks5://host:1080。",
  "settings.agentNetwork.noProxy": "略過地址",
  "settings.agentNetwork.noProxyPlaceholder": "localhost, .example.com",
  "settings.agentNetwork.username": "使用者名稱",
  "settings.agentNetwork.password": "密碼",
  "settings.agentNetwork.passwordConfigured": "已設定密碼",
  "settings.agentNetwork.clearPassword": "清除密碼",
  "settings.agentNetwork.save": "儲存代理設定",
  "settings.agentNetwork.saving": "正在儲存…",
  "settings.agentNetwork.saved": "代理設定已儲存。",
  "settings.agentNetwork.saveFailure": "無法儲存代理設定。",
  "settings.agentNetwork.validation.proxyUrlRequired": "請輸入代理 URL。",
  "settings.agentNetwork.validation.proxyUrlInvalid": "請使用不含認證資訊、僅含主機的 http://、https:// 或 socks5:// URL。",
  "settings.agentNetwork.validation.proxyUrlTooLong": "代理 URL 過長。",
  "settings.agentNetwork.validation.noProxyTooLong": "略過地址過長。",
  "settings.agentNetwork.validation.usernameTooLong": "使用者名稱過長。",
  "settings.agentNetwork.validation.passwordTooLong": "密碼過長。",
  "settings.agentNetwork.validation.controlCharacters": "代理欄位不可包含控制字元。",
  "settings.agentNetwork.validation.passwordRequiresUsername": "設定密碼前請輸入使用者名稱。",
  "settings.cliEnvTitle": "進階：供應商端點與自訂路徑",
  "settings.cliEnvHint":
    "用於覆蓋所選 CLI 的底層環境變數：API key、供應商 Base URL、自訂 home 或非標準可執行檔路徑。不填 Base URL 時，CLI 會使用供應商的預設端點。密鑰只保存在本機應用設定中，且只傳給所選 CLI。",
  "settings.cliEnvClaudeConfigDir": "Claude Code 設定目錄",
  "settings.cliEnvClaudeBaseUrl": "Claude 供應商 Base URL",
  "settings.cliEnvClaudeApiKey": "Claude CLI API key",
  "settings.cliEnvCodexHome": "Codex home",
  "settings.cliEnvCodexBin": "Codex 可執行檔路徑",
  "settings.cliEnvCodexBaseUrl": "Codex/OpenAI 供應商 Base URL",
  ...
  "inlineSwitcher.modelLockedHint": "該模型目前對您的帳戶不可用",
  ...
  "chat.slashPopoverTitle": "命令",
  "chat.slashPopoverHint": "↑↓ 切換 · enter 選擇 · esc 關閉",
  "chat.slashPopoverAria": "斜線命令",
