...
/**
 * Post-create/bootstrap writes run before ProjectView mounts. Refresh the
 * project row first so the patch lands on the daemon's current state, then
 * write it and fail loudly instead of pretending an unseeded project was
