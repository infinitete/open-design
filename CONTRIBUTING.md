...
- **Add telemetry or outbound data collection.** The project ships with no
  telemetry, analytics, or crash-reporting code (see
  [`PRIVACY.md`](PRIVACY.md)). Any PR that reintroduces outbound data
  collection needs prior maintainer discussion and a privacy-contract update
  first.
